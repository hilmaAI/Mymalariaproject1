...
KRdata <- KRdata %>%
  mutate(ml_antimal = case_when(
    ml_fever==1 & !(h37a==1|ml13g==1|ml13n==1|h37b==1|h37c==1|ml13d==1|ml13f==1|ml13e==1|h37h==1) ~ 0,
    ml_fever==1 & (h37a==1|ml13g==1|ml13n==1|h37b==1|h37c==1|ml13d==1|ml13f==1|ml13e==1|h37h==1) ~ 1,
    b5==0  ~ 99),
