# /*******************************************************************************************************************************
# Program: 			MLmain.R - MIS 2020 Kenya
...
data_files <- c("KEHR81FL", "KEIR81FL", "KEPR81FL", "KEKR81FL")
...
dta_files <- c("~/.cache/rdhs/datasets/KEHR81FL.dta",
               "~/.cache/rdhs/datasets/KEIR81FL.dta",
               "~/.cache/rdhs/datasets/KEKR81FL.dta",
               "~/.cache/rdhs/datasets/KEPR81FL.dta")
...
names(data_list) <- c("KEHR81FL", "KEIR81FL", "KEKR81FL", "KEPR81FL")

data_list

## Define datasets
# HR Files
HRdatafile <- data_list$KEHR81FL
# PR Files
PRdatafile <- data_list$KEPR81FL
# IR Files
IRdatafile <- data_list$KEIR81FL
# KR Files
KRdatafile <- data_list$KEKR81FL
...
colnames(KRdatafile)
head(HRdatafile$scounty)
# Get the full name (label) of a specific column
label <- attr(KRdatafile$v024, "label")
print(label)
colnames(KRdatafile)
